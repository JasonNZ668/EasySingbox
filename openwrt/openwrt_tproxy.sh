...
TEMPLATE_URL="https://github.com/JasonNZ668/EasySingbox/raw/refs/heads/master/openwrt/config_tproxy.json"  # 配置文件（规则模板)
TPROXY_PORT=12345  # sing-box tproxy 端口，和配置文件（规则模板）里的端口一致！
PROXY_FWMARK=1
PROXY_ROUTE_TABLE=255
...
table inet sing-box {
    chain prerouting {
        ...
        # 放行局域网流量
        ip daddr { 0.0.0.0/8, 10.0.0.0/8, 100.64.0.0/10, 127.0.0.0/8, 169.254.0.0/16, 172.16.0.0/12, 192.0.0.0/24, 192.0.2.0/24, 192.88.99.0/24, 192.168.0.0/16, 198.18.0.0/15, 198.51.100.0/24, 203.0.113.0/24, 224.0.0.0/4, 240.0.0.0/4, 233.252.0.0/24, 255.255.255.255/32 } accept
        ip6 daddr { ::/128, ::1/128, ::ffff:0:0/96, 100::/64, 64:ff9b::/96, 2001::/32, 2001:10::/28, 2001:20::/28, 2001:db8::/32, 2002::/16, fc00::/7, fe80::/10, ff00::/8 } accept
        #放行所有经过 DNAT 的流量
